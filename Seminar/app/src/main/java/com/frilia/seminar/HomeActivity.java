...
public class HomeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonView.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        Intent a = new Intent(HomeActivity.this, TampilActivity.class);
                        startActivity(a);
                    }
                });
        ArrayAdapter adapter = new ArrayAdapter(HomeActivity.this, R.layout.support_simple_spinner_dropdown_item, JK);
    ...
    private void addEmployee(){
        ...
        class AddEmployee extends AsyncTask<Void, Void, String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(HomeActivity.this, "Menambahkan...", "Tunggu...", false, false);
            }
